...
export const OrderId: { [key: string]: integer } = {
    Absorb: 852529,
    Acidbomb: 852662,
...
export const orderStrings = new Map<integer, string>()
Object.keys(OrderId).forEach(key => orderStrings.set(OrderId[key], key))

export const Order = {
    test: () =>
        setInterval(0.1, () =>
            ObjectOptions.values(OrderId).forEach(value => print(OrderId2String(value)))
        )
}
